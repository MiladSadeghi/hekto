    ...
    <div>
      <div className='bg-[#F6F5FF] py-16'>
        <div className='container mx-auto'>
          <h1 className='font-JosefinSans font-bold text-3xl text-[#101750]'>FAQ</h1>
        </div>
      </div>
      <div className='container mx-auto mt-24 mb-20'>
        <div className='flex gap-8 mb-20'>
          <div className='w-full'>
            <h5 className='text-[#1D3178] font-bold text-4xl font-JosefinSans mb-16'>General Information</h5>
            <div className='flex flex-col'>
              {
                informations.map(item => (
                  <div className='mb-14' key={item.title}>
                    <h6 className='font-JosefinSans font-bold text-lg text-[#1D3178] mb-5'>{item.title}</h6>
                    <p className='font-JosefinSans text-base text-[#A1ABCC]'>{item.body}</p>
                  </div>
                ))
              }
            </div>
          ...
          <div className='w-full px-9 py-16 bg-[#F8F8FD]'>
            <h5 className='text-2xl font-bold font-JosefinSans text-[#1D3178]'>Ask a Question</h5>
            <div className='mt-24'>
              <input type="text" className='form-input py-2 mb-10' placeholder='Your Name*'/>
              <input type="text" className='form-input py-2 mb-10' placeholder='Subject*' />
              <textarea className='form-input resize-none' rows={8}placeholder='Type Your Message*' />
              <button className='font-JosefinSans text-base font-semibold bg-pink-cc py-3 px-10 text-white rounded-[3px] mt-5'>Send Mail</button>
            </div>
          </div>
        </div>
        <Logos />

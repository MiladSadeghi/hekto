    ...
    <div className="flex flex-col group">
      <div className="bg-[#F6F7FB] rounded-full w-full h-[269px] flex items-center justify-center relative  z-30 overflow-hidden">
        <img
          ...
          alt={data.title}
        />
        <button className="absolute font-JosefinSans w-[88px] h-[29px] text-[12px] left-1/2 -translate-x-1/2 -bottom-8 rounded-sm bg-[#08D15F] text-white group-hover:bottom-5 duration-300 overflow-hidden">
          View Shop
        </button>
      </div>
